...
try:
    ...
    # mypy may fail on these if stubs aren't installed or env is separated
    pass
...
class XlsxProcessor(BaseFileProcessor):
    ...
    def __init__(self) -> None:
        ...
        self._cell_map: dict[str, Any] = {}  # id -> cell reference
        self._image_map: dict[str, Any] = {}  # id -> (sheet_idx, image_idx)
    ...
    def load(self, file_path: str | Path) -> None:
        ...
        try:
            ...
            logger.info(
                f"Loaded XLSX: {path.name} ({len(self._document.sheetnames)} sheets)"
            )
